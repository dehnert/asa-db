...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Midway'
        db.create_table('forms_midway', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('table_map', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('forms', ['Midway'])

        # Adding model 'MidwayAssignment'
        db.create_table('forms_midwayassignment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('midway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.Midway'])),
        ...
        db.send_create_signal('forms', ['MidwayAssignment'])

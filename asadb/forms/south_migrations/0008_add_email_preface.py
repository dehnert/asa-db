...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupMembershipUpdate.email_preface'
        db.add_column('forms_groupmembershipupdate', 'email_preface', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'GroupMembershipUpdate.no_discrimination'
        db.add_column('forms_groupmembershipupdate', 'no_discrimination', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupMembershipUpdate.email_preface'
        db.delete_column('forms_groupmembershipupdate', 'email_preface')

        # Deleting field 'GroupMembershipUpdate.no_discrimination'
        db.delete_column('forms_groupmembershipupdate', 'no_discrimination')
    ...
    models = {
        ...
        'forms.groupmembershipupdate': {
            ...
            'email_preface': ('django.db.models.fields.TextField', [], {}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['groups.Group']"}),

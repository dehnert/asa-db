...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PeopleStatusLookup'
        db.create_table('forms_peoplestatuslookup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('people', self.gf('django.db.models.fields.TextField')()),
            ('requestor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ...
            ('classified_people_json', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('forms', ['PeopleStatusLookup'])


    def backwards(self, orm):
        
        # Deleting model 'PeopleStatusLookup'
        db.delete_table('forms_peoplestatuslookup')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 2, 4, 14, 30, 678016)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 2, 4, 14, 30, 677924)'}),
        ...
        'forms.fysm': {
            ...
            'slide': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
        ...
        'forms.groupmembershipupdate': {
            ...
            'membership_list': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'forms.peoplestatuslookup': {
            'Meta': {'object_name': 'PeopleStatusLookup'},
            'classified_people_json': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'people': ('django.db.models.fields.TextField', [], {}),
            'referer': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'requestor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),

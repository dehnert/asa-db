...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PersonMembershipUpdate'
        db.create_table('forms_personmembershipupdate', (
        ...
        db.send_create_signal('forms', ['PersonMembershipUpdate'])

        # Adding M2M table for field groups on 'PersonMembershipUpdate'
        db.create_table('forms_personmembershipupdate_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personmembershipupdate', models.ForeignKey(orm['forms.personmembershipupdate'], null=False)),
            ('group', models.ForeignKey(orm['groups.group'], null=False))
        ))
        db.create_unique('forms_personmembershipupdate_groups', ['personmembershipupdate_id', 'group_id'])

        # Adding field 'GroupMembershipUpdate.group_email'
        db.add_column('forms_groupmembershipupdate', 'group_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Adding field 'GroupMembershipUpdate.officer_email'
        db.add_column('forms_groupmembershipupdate', 'officer_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PersonMembershipUpdate'
        db.delete_table('forms_personmembershipupdate')

        # Removing M2M table for field groups on 'PersonMembershipUpdate'
        db.delete_table('forms_personmembershipupdate_groups')

        # Deleting field 'GroupMembershipUpdate.group_email'
        db.delete_column('forms_groupmembershipupdate', 'group_email')

        # Deleting field 'GroupMembershipUpdate.officer_email'
        db.delete_column('forms_groupmembershipupdate', 'officer_email')

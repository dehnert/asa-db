...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupMembershipUpdate.cycle'
        db.add_column('forms_groupmembershipupdate', 'cycle', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forms.GroupConfirmationCycle']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupMembershipUpdate.cycle'
        db.delete_column('forms_groupmembershipupdate', 'cycle_id')

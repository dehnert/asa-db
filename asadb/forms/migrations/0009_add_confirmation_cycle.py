...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupConfirmationCycle'
        db.create_table('forms_groupconfirmationcycle', (
        ...
        db.send_create_signal('forms', ['GroupConfirmationCycle'])

        # Adding field 'PersonMembershipUpdate.cycle'
        db.add_column('forms_personmembershipupdate', 'cycle', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forms.GroupConfirmationCycle']), keep_default=False)

        # Adding field 'PersonMembershipUpdate.deleted'
        db.add_column('forms_personmembershipupdate', 'deleted', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True), keep_default=False)

        # Adding field 'PersonMembershipUpdate.valid'
        db.add_column('forms_personmembershipupdate', 'valid', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'GroupConfirmationCycle'
        db.delete_table('forms_groupconfirmationcycle')

        # Deleting field 'PersonMembershipUpdate.cycle'
        db.delete_column('forms_personmembershipupdate', 'cycle_id')

        # Deleting field 'PersonMembershipUpdate.deleted'
        db.delete_column('forms_personmembershipupdate', 'deleted')

        # Deleting field 'PersonMembershipUpdate.valid'
        db.delete_column('forms_personmembershipupdate', 'valid')
    ...
    models = {
        ...
        'forms.personmembershipupdate': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.updater'
        db.alter_column('groups_group', 'updater', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))


    def backwards(self, orm):
        
        # Changing field 'Group.updater'
        db.alter_column('groups_group', 'updater', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupStartup.submitter'
        db.add_column('groups_groupstartup', 'submitter', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupStartup.submitter'
        db.delete_column('groups_groupstartup', 'submitter')

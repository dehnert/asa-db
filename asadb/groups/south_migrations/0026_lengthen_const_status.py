...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupConstitution.status_msg'
        db.alter_column('groups_groupconstitution', 'status_msg', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'GroupConstitution.status_msg'
        db.alter_column('groups_groupconstitution', 'status_msg', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 1, 47, 43, 607205)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 1, 47, 43, 607118)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupConstitution'
        db.create_table('groups_groupconstitution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.Group'], unique=True)),
            ('source_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('dest_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('last_update', self.gf('django.db.models.fields.DateTimeField')()),
            ('last_download', self.gf('django.db.models.fields.DateTimeField')()),
            ('failure_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('status_msg', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('failure_reason', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
        ))
        db.send_create_signal('groups', ['GroupConstitution'])


    def backwards(self, orm):
        
        # Deleting model 'GroupConstitution'
        db.delete_table('groups_groupconstitution')

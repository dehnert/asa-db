...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.recognition_date'
        db.alter_column('groups_group', 'recognition_date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Group.recognition_date'
        db.alter_column('groups_group', 'recognition_date', self.gf('django.db.models.fields.DateField')())

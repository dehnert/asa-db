...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AthenaMoiraAccount.affiliation_basic'
        db.add_column('groups_athenamoiraaccount', 'affiliation_basic', self.gf('django.db.models.fields.CharField')(default='affiliate', max_length=10), keep_default=False)

        # Adding field 'AthenaMoiraAccount.affiliation_detailed'
        db.add_column('groups_athenamoiraaccount', 'affiliation_detailed', self.gf('django.db.models.fields.CharField')(default='MIT Affiliate', max_length=40), keep_default=False)

        # Adding field 'AthenaMoiraAccount.loose_student'
        db.add_column('groups_athenamoiraaccount', 'loose_student', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AthenaMoiraAccount.affiliation_basic'
        db.delete_column('groups_athenamoiraaccount', 'affiliation_basic')

        # Deleting field 'AthenaMoiraAccount.affiliation_detailed'
        db.delete_column('groups_athenamoiraaccount', 'affiliation_detailed')

        # Deleting field 'AthenaMoiraAccount.loose_student'
        db.delete_column('groups_athenamoiraaccount', 'loose_student')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 15, 5, 43, 8, 171661)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 15, 5, 43, 8, 171566)'}),
        ...
        'groups.athenamoiraaccount': {
            ...
            'affiliation_basic': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'affiliation_detailed': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            ...
            'loose_student': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'groups.groupconstitution': {
            ...
            'status_msg': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'groups.groupfunding': {

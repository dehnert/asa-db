...
# Based on groups/migrations/0017_add_officerroles.py
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for slug in ['temp-admin']:
            try:
                orm['groups.officerrole'].objects.get(
                    slug=slug,
                ).delete()
            except orm['groups.officerrole'].DoesNotExist:
                    print >>sys.stderr, "OfficerRole %s does not exist while attempting to remove it." % (slug, )
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 26, 4, 28, 46, 503663)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 26, 4, 28, 46, 503560)'}),

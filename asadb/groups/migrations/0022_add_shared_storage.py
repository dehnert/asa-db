...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        defaults = {}
        defaults['display_name'] = 'Shared Storage Access'
        slug = 'locker-access'
        defaults['description'] = 'People with card access for W20-437 and W20-441 shared storage spaces for groups with locker/shelf space in those rooms.'
        defaults['max_count'] = 6
        defaults['require_student'] = False
        defaults['grant_user'] = None
        defaults['publicly_visible'] = False
        officerrole, created = orm['groups.officerrole'].objects.get_or_create(slug=slug, defaults=defaults)


    def backwards(self, orm):
        "Write your backwards methods here."
        print "Refraining from removing OfficerRole for locker-access."

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupStartup'
        db.create_table('groups_groupstartup', (
            ...
            ('create_officer_list', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('create_group_list', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('create_athena_locker', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('president_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('president_kerberos', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('treasurer_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('treasurer_kerberos', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ))
        db.send_create_signal('groups', ['GroupStartup'])


    def backwards(self, orm):
        
        # Deleting model 'GroupStartup'
        db.delete_table('groups_groupstartup')

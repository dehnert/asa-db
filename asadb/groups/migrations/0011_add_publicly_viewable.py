...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OfficerRole.publicly_visible'
        db.add_column('groups_officerrole', 'publicly_visible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OfficerRole.publicly_visible'
        db.delete_column('groups_officerrole', 'publicly_visible')

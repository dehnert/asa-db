...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OfficerRole.grant_user'
        db.add_column('groups_officerrole', 'grant_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OfficerRole.grant_user'
        db.delete_column('groups_officerrole', 'grant_user_id')

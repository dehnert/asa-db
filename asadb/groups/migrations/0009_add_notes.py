...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupNote'
        db.create_table('groups_groupnote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('acl_read_group', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('acl_read_offices', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.Group'])),
        ))
        db.send_create_signal('groups', ['GroupNote'])


    def backwards(self, orm):
        
        # Deleting model 'GroupNote'
        db.delete_table('groups_groupnote')
